...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Poster Cairo widget"
      End
...
Private Sub mnuAppFolder_Click()
   ...
   On Error GoTo mnuAppFolder_Click_Error
    ...
    Else
        MsgBox "Having a bit of a problem opening a folder for this widget - " & folderPath & " It doesn't seem to have a valid working directory set.", "Element Widget Confirmation Message", vbOKOnly + vbExclamation
        'MessageBox Me.hWnd, "Having a bit of a problem opening a folder for that command - " & sCommand & " It doesn't seem to have a valid working directory set.", "Element Gauge Confirmation Message", vbOKOnly + vbExclamation
    End If
...
Private Sub mnuEditWidget_Click()
   ...
   On Error GoTo mnuEditWidget_Click_Error
    ...
    Else
        ...
        'MessageBox Me.hWnd, "Having a bit of a problem opening a folder for that command - " & sCommand & " It doesn't seem to have a valid working directory set.", "Element Widget Confirmation Message", vbOKOnly + vbExclamation
    End If
...
Private Sub mnuHelpHTM_Click()
    On Error GoTo mnuHelpHTM_Click_Error
        ...
        Else
            MsgBox ("The help file - Element.html.html- is missing from the help folder.")
        End If
...
Private Sub mnuLockWidget_Click()
    ...
    If gblPlPreventDragging = "1" Then
        ...
        posterPrefs.chkPreventDragging.Value = 0
    Else
        mnuLockWidget.Checked = True
        ElementWidget.Locked = 1
        gblPlPreventDragging = "1"
        posterPrefs.chkPreventDragging.Value = 1
    End If
...
Public Sub mnuLatest_Click()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Poster-VB6-Widget/raw/main/Setup.exe", vbNullString, App.Path, 1)
    End If
