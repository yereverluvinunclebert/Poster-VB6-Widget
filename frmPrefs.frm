...
loadHigherResPrefsImages_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure loadHigherResPrefsImages of Form posterPrefs"
End Sub
'---------------------------------------------------------------------------------------
...
setPrefsIconImagesDark_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setPrefsIconImagesDark of Form posterPrefs"
...
setPrefsIconImagesLight_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setPrefsIconImagesLight of Form posterPrefs"
